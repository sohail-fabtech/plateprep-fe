...
export default function RoleTableRow({
  ...
  const { id, name, description, permissionsCount, usersCount, isDeleted } = row;
  ...
  // In "All" tab, if role is deleted, disable the menu (similar to user table)
    ...
    <>
      <TableRow hover sx={{ ...(dense && { height: 52 }) }}>
        ...
        {columnVisibility.description && (
          <TableCell sx={{ px: { xs: 1.5, md: 2 }, maxWidth: 300, ...(dense && { py: 1 }), ...defaultTableCellStyles }}>
            <Typography
              variant="body2"
              sx={{
                fontSize: { xs: '0.8125rem', sm: '0.875rem', md: '0.9375rem' },
              ...
              title={description || ''}
            >
              {description ? truncateText(description, 40) : '-'}
            </Typography>
          </TableCell>
        )}
        ...
        {columnVisibility.permissions_count && (
          <TableCell sx={{ px: { xs: 1.5, md: 2 }, ...(dense && { py: 1 }), ...defaultTableCellStyles }}>
            <Label color="info" sx={{ fontSize: { xs: '0.6875rem', md: '0.75rem' } }}>
              {permissionsCount}
            </Label>
          </TableCell>
        )}
      ...
      <MenuPopover open={openPopover} onClose={handleClosePopover} arrow="right-top" sx={{ width: 160 }}>
        ...
        {/* In "All" tab, if role is deleted, show Delete instead of Archive */}
        {isArchived && isInAllTab ? (
          ...
          // In "active" or "all" tab for active roles, show Archive
          showArchive && (
            <MenuItem
              onClick={() => {
      ...
      <ConfirmDialog
        ...
        title="Archive Role"
        content="Are you sure you want to archive this role? You can restore it later from the archived tab."
        action={
          <Button
            variant="contained"
            disabled={isLoading}
      ...
      <ConfirmDialog
        ...
        title="Restore Role"
        content="Are you sure you want to restore this role? The role will be moved back to the active list."
        action={
          <Button
            variant="contained"
            color="success"
